...
export default function ColumnTable(props) {
  ...
  const columns = [
    ...
    columnHelper.accessor('cuotapartes', {
      id: 'cuotapartes',
      header: () => (
        <Text
          justifyContent="space-between"
    ...
    columnHelper.accessor('precioCuota', {
      id: 'precioCuota',
      header: () => (
        <Text
          justifyContent="space-between"
    ...
    columnHelper.accessor('pyl', {
      ...
      cell: (info) => {
        ...
        // Calcula P&L: (valor actual - precio de compra) * cuotapartes
        const pnl = (currentValorCuota - row.precioCuota) * row.cuotapartes;
        return (
          <Text
